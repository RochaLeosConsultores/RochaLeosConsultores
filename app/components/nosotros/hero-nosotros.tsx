        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative order-1 lg:order-2">
            <div className="relative w-full aspect-video overflow-hidden rounded-2xl border border-white/10 shadow-2xl">
              <iframe
                src="https://player.mux.com/vSdtBsmfVyLIx1oKYuasjxTmsvbwYeLAiHjqNGyQEMU?metadata-video-title=VIDEO+INSTITUCIONAL+RLCONSULTORES&video-title=VIDEO+INSTITUCIONAL+RLCONSULTORES"
                title="Video institucional RL Consultores"
