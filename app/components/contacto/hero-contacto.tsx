  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-[#1F3A5F] to-[#2d5280] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/4 w-72 h-72 bg-[#BFC5CA]/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/2 right-1/4 w-72 h-72 bg-[#BFC5CA]/10 rounded-full blur-3xl"></div>
      </div>
